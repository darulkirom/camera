...
public class VideoModule extends CameraModule
    ...
    private void initializeRecorder() {
        ...
        // Mp4 muxer will hold data to write when stop record, the data size will go up with
        // the file size. If the storage is large such as 8GB, the data hold will more than 50MB.
        ...
        Log.i(TAG, "maxFileSize " + maxFileSize + " spaceLeft " + spaceLeft +
